        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((b, i) => (
            <motion.div
              ...
              className="group bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:border-orange-100 transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-xl bg-[#FFF7F0] flex items-center justify-center mb-4 group-hover:bg-[#FF7A00] transition-colors duration-300">
                <b.icon size={22} className="text-[#FF7A00] group-hover:text-white transition-colors duration-300" />
              </div>
              <h3 className="font-bold text-gray-900 text-sm mb-2 tracking-wide">
                {b.title}
              </h3>
